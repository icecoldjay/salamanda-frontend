            ...
            <div className="grid lg:grid-cols-2 gap-15">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-[#141414] rounded-lg p-6">
                  ...
                  <p className=" lg:text-[56px] sm:text-[32px] font-[800] lg:leading-[64px] mt-12">$20.1K</p>
                </div>
      
                {/* Box 2 */}
                <div className="bg-[#141414] rounded-lg  p-6">
                  <p className="text-[#4a4a4a] lg:text-[18px] mb-2">Tokens distributed</p>
                  <p className="lg:text-[56px] sm:text-[32px] font-[800] lg:leading-[64px] mt-12">1.8M</p>
                </div>
      
                {/* Box 3 (Duplicate of 1 for symmetry) */}
                <div className="bg-[#141414] rounded-lg sm:p-2 p-6">
                  <p className="text-[#4a4a4a] lg:text-[18px] mb-2">All time volume</p>
                  <p className="lg:text-[56px] sm:text-[32px]font-[800] lg:leading-[64px] mt-12">$20.1K</p>
                </div>
                ...
                <div className="bg-[#190101] rounded-lg sm:p-2 p-6">
                  ...
                  <p className="lg:text-[56px] sm:text-[32px] text-[#C50404]  font-[800] lg:leading-[64px] sm:leading-[44px] mt-12">$9.3K</p>
                </div>
              </div>
            </div>
          </section>
