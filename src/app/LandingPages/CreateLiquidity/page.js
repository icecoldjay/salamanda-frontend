...
const CreateLiquidity = () => {
  return (
    <div className={`${archivo.variable}`}>
        <Header/>
             <div>
              <h1 className="font-[Archivo] text-white font-extrabold text-[56px] sm:text-3xl md:text-4xl lg:text-6xl sm:leading-[40px] lg:leading-[64px] text-center mx-auto w-full sm:w-[80%] md:w-[70%] lg:w-[40%] pt-10 pb-5">
